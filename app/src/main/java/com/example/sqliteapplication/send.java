...
public class send extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendtouse);
    ...
    private void showData(String phonenumber) {
        ...
        adapter = new sendAdapter(send.this, modelList_sendtouser);
    ...
    public void selectuser(int position) {
        ...
        while(cursor.moveToNext()) {
            ...
            startActivity(new Intent(send.this, customerList.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(send.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(send.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(send.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(send.this, customerList.class));
                        finish();
                    }
