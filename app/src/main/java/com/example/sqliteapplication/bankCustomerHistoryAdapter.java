...
public class bankCustomerHistoryAdapter extends RecyclerView.Adapter<ViewHolder> {

    com.example.sqliteapplication.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public bankCustomerHistoryAdapter(com.example.sqliteapplication.HistoryList historyList, List<Model> modelList) {
